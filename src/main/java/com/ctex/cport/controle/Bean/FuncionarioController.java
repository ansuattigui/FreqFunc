...
public class FuncionarioController implements Serializable {
    ...
    @EJB
    private com.ctex.cport.controle.Bean.FuncionarioFacade ejbFacade;
    ...
    public void setItems(List<Funcionario> items) {
        this.items = items;
    }
